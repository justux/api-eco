...
[**createUsersWithArrayInput**](UserApi.md#createUsersWithArrayInput) | **POST** /createWithArray | Creates list of users with given input array
[**createUsersWithListInput**](UserApi.md#createUsersWithListInput) | **POST** /createWithList | Creates list of users with given input array
[**deleteUser**](UserApi.md#deleteUser) | **DELETE** /{username} | Delete user
[**getUserByName**](UserApi.md#getUserByName) | **GET** /{username} | Get user by user name
[**loginUser**](UserApi.md#loginUser) | **GET** /login | Logs user into the system
[**logoutUser**](UserApi.md#logoutUser) | **GET** /logout | Logs out current logged in user session
[**updateUser**](UserApi.md#updateUser) | **PUT** /{username} | Updated user
